  ...
  return (
    ...
    >
      ...
      <div className="relative w-full md:mt-80 mt-36">
        ...
        <div className="overflow-hidden w-full bg-gradient-to-b dark:from-black from-orange-50 via-orange-100 dark:via-neutral-950 dark:to-orange-500 to-orange-500 py-2">
          <motion.div
